...
final class MeldedFormedYakuTests: XCTestCase {
    ...
    func test役牌() {
        ...
        assert((東, 東), (一索, 二索, 三索), (西, 西, 西), (北, 北, 北), (南, 南, 南), shouldNotBe: 役牌.self)
        assert((一筒, 一筒), (一索, 二索, 三索), (四索, 五索, 六索), (七索, 八索, 九索), (東, 東, 東), shouldBe: 役牌.self, 2)
        assert((一筒, 一筒), (一索, 二索, 三索), (四索, 五索, 六索), (中, 中, 中), (東, 東, 東), shouldBe: 役牌.self, 3)
        assert((一筒, 一筒), (一索, 二索, 三索), (四索, 五索, 六索), (七索, 八索, 九索), (發, 發, 發), shouldBe: 役牌.self, 1)
        assert((一筒, 一筒), (一索, 二索, 三索), (四索, 五索, 六索), (白, 白, 白), (發, 發, 發), shouldBe: 役牌.self, 2)
        assert((一筒, 一筒), (一索, 二索, 三索), (四索, 五索, 六索), (白, 白, 白), (北, 北, 北), shouldBe: 役牌.self, 1)
